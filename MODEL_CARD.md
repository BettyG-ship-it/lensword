...
**Authors:** Betty George and Miheret Woldegabrial
**Program:** AI/ML Engineering Program, Apeiron AI Training, July 2026
...
**BiLSTM (primary, in production)**
Architecture: Bidirectional LSTM, 2 layers, hidden dim 64, dropout 0.4
Parameters: 444,035
Vocabulary: 4,340 words fitted on training data only
Sequence length: 50 tokens

**DistilBERT (fine-tuned, Notebook 06)**
Base model: distilbert-base-uncased from HuggingFace
Fine-tuned on our amazon_yelp_combined.csv
...
Knowledge base: 33 RAG entries across 7 complaint categories.
Protection guards: 18 across api.py, customer.html, index.html, and Docker.
LangGraph nodes: 13 across three conversation flows.
